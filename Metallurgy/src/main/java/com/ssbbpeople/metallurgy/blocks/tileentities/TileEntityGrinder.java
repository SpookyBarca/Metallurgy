package com.ssbbpeople.metallurgy.blocks.tileentities;
...
import com.ssbbpeople.metallurgy.blocks.grinder.GrinderRecipes;
...
public class TileEntityGrinder extends TileEntity implements IInventory, ISidedInventory {
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack itemstack = GrinderRecipes.instance().getCookingResult(this.furnaceItemStacks.get(0));
    ...
    public void smeltItem()
    {
        if (this.canSmelt())
        {
            ...
            ItemStack itemstack1 = GrinderRecipes.instance().getCookingResult(itemstack);
    ...
    public boolean isItemValidForSlot(int index, ItemStack stack) 
    {
    	...
    	{
    		ItemStack itemStack = this.furnaceItemStacks.get(1);
    		return isItemFuel(stack) || SlotGrinderFuel.isBucket(stack) && itemStack.getItem() != Items.BUCKET;
    	}
    }
